...
export interface GroupClientMessageViewProps {
  buttonText?: string;
  emailContent?: string;
  emailTitle?: string;
  headerTitle?: string;
...
export function GroupClientMessageView({
  headerTitle = "Message",
  imageUrl = "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800",
  emailTitle = "Emai titel",
  emailContent = "Lorem ipsum dolor sit amet consectetur. Sed lobortis dictumst fermentum tempus arcu vel. Cursus sed augue arcu congue amet. Nunc interdum donec aenean volutpat augue mauris semper quis. Etiam et netus ullamcorper nisl massa potenti lacinia odio.",
  smsContent = "Lorem ipsum dolor sit amet consectetur. Sed lobortis dictumst fermentum tempus arcu vel. Cursus sed augue arcu congue amet. Nunc interdum donec aenean volutpat augue mauris semper quis. Etiam et netus ullamcorper nisl massa potenti lacinia odio.",
  buttonText = "Create message to 233 clint",
  onBack,
  onSubmit,
}: GroupClientMessageViewProps) {
  return (
