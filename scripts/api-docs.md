...
- **Base URL:** `EXPO_PUBLIC_SERVER_URL/api` (configured in `@/lib/env` and `@/lib/ky`)
...
### shops gallery create

**Method & Path:** `POST /v1/shops/gallery/`

---

### shops gallery update
...
### shops payment-settings partial update
...
**Method & Path:** `GET /v1/bookings/reviews/`

---

### reviews read

**Method & Path:** `GET /v1/bookings/reviews/:id/`
...
### google reviews create

**Method & Path:** `PUT /v1/bookings/reviews/:id/`
...
{
  "rating": 4,
  "comment": "Updated comment: Still good but could be cleaner."
}
```
...
**Method & Path:** `DELETE /v1/bookings/reviews/:id/`
